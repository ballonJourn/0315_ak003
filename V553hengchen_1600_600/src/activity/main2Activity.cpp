...
static S_ButtonCallback sButtonCallbackTab[] = {
    ID_MAIN2_BluetoothappButton, onButtonClick_BluetoothappButton,
    ID_MAIN2_PlaybackButton, onButtonClick_PlaybackButton,
    ID_MAIN2_MCButton, onButtonClick_MCButton,
    ID_MAIN2_AudioOutputButton, onButtonClick_AudioOutputButton,
    ID_MAIN2_ACButton, onButtonClick_ACButton,
    ID_MAIN2_wifiVideoButton, onButtonClick_wifiVideoButton,
    ID_MAIN2_APButton, onButtonClick_APButton,
    ID_MAIN2_SETButton, onButtonClick_SETButton,
    ID_MAIN2_AAButton, onButtonClick_AAButton,
    ID_MAIN2_CPButton, onButtonClick_CPButton,
};
/***************/
...
void main2Activity::onCreate() {
	Activity::onCreate();
    mlinkTipsTextViewPtr = (ZKTextView*)findControlByID(ID_MAIN2_linkTipsTextView);
    mlinkTipsWindowPtr = (ZKWindow*)findControlByID(ID_MAIN2_linkTipsWindow);
    mBluetoothappButtonPtr = (ZKButton*)findControlByID(ID_MAIN2_BluetoothappButton);
    mPlaybackButtonPtr = (ZKButton*)findControlByID(ID_MAIN2_PlaybackButton);
    mMCButtonPtr = (ZKButton*)findControlByID(ID_MAIN2_MCButton);
    mAudioOutputButtonPtr = (ZKButton*)findControlByID(ID_MAIN2_AudioOutputButton);
    mACButtonPtr = (ZKButton*)findControlByID(ID_MAIN2_ACButton);
    mwifiVideoButtonPtr = (ZKButton*)findControlByID(ID_MAIN2_wifiVideoButton);
    mAPButtonPtr = (ZKButton*)findControlByID(ID_MAIN2_APButton);
    mSETButtonPtr = (ZKButton*)findControlByID(ID_MAIN2_SETButton);
    mAAButtonPtr = (ZKButton*)findControlByID(ID_MAIN2_AAButton);
    mCPButtonPtr = (ZKButton*)findControlByID(ID_MAIN2_CPButton);
    mWindow2Ptr = (ZKWindow*)findControlByID(ID_MAIN2_Window2);
	mActivityPtr = this;
	onUI_init();
